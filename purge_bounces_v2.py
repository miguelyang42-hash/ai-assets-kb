...
def clean_database():
    ...
    # Use temporary file to avoid permission issues if possible
    ...
    try:
        ...
        print(f"CRITICAL: Permission Denied on {MASTER_CSV}. Please close the file if it is open in Excel.")
