...
**Mode variations:**
- Analysis-only: skip dimensions 4 and 5, keep 1, 2, 3, 6
- English-only: case matching first, then English-only for dimensions 4 and 5
- Chat-primary: dimension 5 becomes primary with expanded content (6-8 lines)
